...
<!--    <input type="hidden" name="types[]" value="SMSPOH_API_KEY">-->
<!--    <div class="col-lg-3">-->
<!--        <label class="col-from-label">{{ translate('SMSPOH API KEY') }}</label>-->
<!--    </div>-->
<!--    <div class="col-lg-6">-->
<!--        <input type="text" class="form-control" name="SMSPOH_API_KEY"-->
<!--            value="{{ env('SMSPOH_API_KEY') }}" placeholder="SMSPOH API KEY" required>-->
<!--    </div>-->
<!--</div>-->

<!--<div class="form-group row">-->
<!--    <input type="hidden" name="types[]" value="SMSPOH_SENDER_ID">-->
<!--    <div class="col-lg-3">-->
<!--        <label class="col-from-label">{{ translate('SMSPOH SENDER ID') }}</label>-->
<!--    </div>-->
<!--    <div class="col-lg-6">-->
<!--        <input type="text" class="form-control" name="SMSPOH_SENDER_ID"-->
<!--            value="{{ env('SMSPOH_SENDER_ID') }}" placeholder="SMSPOH SENDER ID" required>-->
<!--        <small>-->
...
<!--    <div class="col-lg-3">-->
<!--        <label class="col-from-label">{{ translate('SMS Poh') }} </label>-->
<!--    </div>-->
<!--    <div class="col-lg-6">-->
<!--        <input type="text" class="form-control" name="SMSPOH_KEY" value="{{ env('SMSPOH_KEY') }}"-->
<!--            placeholder="SMS Poh KEY" required>-->
<!--    </div>-->
<!--</div>-->
...
<!--    </div>-->
<!--    <div class="col-lg-6">-->
<!--        <input type="text" class="form-control" name="SMSPOH_SENDER_ID" value="{{  env('SMSPOH_SENDER_ID') }}" placeholder="NEXMO SENDER ID" required>-->
<!--        <small>-->
...
<div class="form-group row">
    <input type="hidden" name="types[]" value="SMSPOH_KEY">
    <div class="col-lg-3">
        <label class="col-from-label">{{ translate('SMSPOH_KEY') }}</label>
    </div>
    <div class="col-lg-6">
        <input type="text" class="form-control" name="SMSPOH_KEY"
            value="{{ env('SMSPOH_KEY') }}" placeholder="SMSPOH API KEY" required>
    </div>
</div>
...
<div class="form-group row">
    <input type="hidden" name="types[]" value="SMSPOH_SENDER_ID">
    <div class="col-lg-3">
        <label class="col-from-label">{{ translate('SMSPOH_SENDER_ID') }}</label>
    </div>
    <div class="col-lg-6">
        <input type="text" class="form-control" name="SMSPOH_SENDER_ID"
            value="{{ env('SMSPOH_SENDER_ID') }}" placeholder="SMSPOH SENDER ID" required>
