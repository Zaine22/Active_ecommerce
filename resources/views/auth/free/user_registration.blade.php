        ...
        >
            ...
            >
                ...
                <div class="col-xxl-6 col-lg-7">
                    <div class="h-100">
                        <img
                            src="{{ uploaded_asset(get_setting("customer_register_page_image")) }}"
                            alt=""
                            class="img-fit h-100"
                        >
                    </div>
                        ...
                        <div class="row align-items-center justify-content-center justify-content-lg-start h-100">
                            <div class="col-xxl-6 p-4 p-lg-5">
                                ...
                                <div class="size-48px mb-3 mx-auto mx-lg-0">
                                    <img
                                        src="{{ uploaded_asset(get_setting("site_icon")) }}"
                                ...
                                <div class="text-center text-lg-left">
                                    <h1
                                        class="fs-20 fs-md-24 fw-700 text-primary"
                                ...
                                <div class="pt-3 pt-lg-4 bg-white">
                                    <div class="">
                                        ...
                                        >
                                            ...
                                            <div class="form-group">
                                                <label
                                                    for="name"
                                                    class="fs-12 fw-700 text-soft-dark"
                                                ...
                                                <label class="aiz-checkbox">
                                                    ...
                                                    <span
                                                        ...
                                                        <a
                                                            href="{{ route("terms") }}"
                                                            class="fw-500"
                                                        >{{ translate("terms and conditions.") }}</a></span>
                                            ...
                                            <div class="mb-4 mt-4">
                                                <button
                                                    type="submit"
                                                    class="btn btn-primary btn-block fw-600 rounded-0"
                                    ...
                                    <p class="fs-12 text-gray mb-0">
                                        ...
                                        <a
                                            ...
                                            class="ml-2 fs-14 fw-700 animate-underline-primary"
                                        >{{ translate("Log In") }}</a>
                                    </p>
                                    <!-- Go Back -->
                                    <a
