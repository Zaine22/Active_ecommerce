...
>
    <div
        class="modal-dialog modal-adaptive"
        role="document"
    >
            ...
            <div class="modal-header pb-0 bg-light">
                <div class="uppy-modal-nav">
                    <ul class="nav nav-tabs border-0">
                        <li class="nav-item">
                            <a
                                class="nav-link active font-weight-medium text-dark"
                                data-toggle="tab"
                                href="#aiz-select-file"
                            >{{ translate("Select File") }}</a>
                        </li>
                        <li class="nav-item">
                            <a
            ...
            <div class="modal-footer justify-content-between bg-light">
                <div class="flex-grow-1 overflow-hidden d-flex">
                    <div class="">
                        ...
                        <button
                            type="button"
                            class="btn-link btn btn-sm p-0 aiz-uploader-selected-clear"
